<x-app-layouts title="Daftar Barang Masuk">
    <x-search action="{{ route('admin.barangMasuk.index') }}" />
    <div class="card">
        <div class="card-header d-flex justify-content-between">
            <h4>Daftar Barang Masuk</h4>
            <a href="{{ route('admin.barangMasuk.create') }}" class="btn btn-success btn-sm">
                ...
                <tbody>
                    @foreach($barangMasuks as $barangMasuk)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.barangMasuk.edit', $barangMasuk->id) }}" class="btn btn-primary btn-sm">
                                    <i class="fas fa-edit"></i> Edit
                                </a>
                                <form action="{{ route('admin.barangMasuk.destroy', $barangMasuk->id) }}" method="POST" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
